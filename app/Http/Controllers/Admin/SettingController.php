    ...
    public function seo(Request $request)
    {
        ...
        try {
            ...
            $data = [
                ...
                'seo:login-title' => $request->get('login_title'),
                'seo:register-title' => $request->get('register_title'),
                ...
                'seo:login-meta-description' => $request->get('login_meta_description'),
                'seo:register-meta-description' => $request->get('register_meta_description'),
