<template>
    <div :style="`height: ${height}px`">
        ...
        >
            ...
            <l-circle v-if="layer && target_coordinates" :lat-lng="target_coordinates" :radius="radius" color="green">
                <l-popup content="ملک در این منطقه قرار دارد" />
            </l-circle>
        </l-map>
...
export default {
    ...
    data() {
        return {
            mapElementId: 'neshan-admin-map-' + Math.random().toString(36).slice(2),
            neshanMap: null,
            neshanOverlay: null,
            map: null,
            data_zoom: 0,
    ...
    methods: {
        ...
        renderNeshanOverlay(center) {
            ...
            if (this.layer) {
                ...
                this.neshanOverlay.bindPopup('ملک در این منطقه قرار دارد')
