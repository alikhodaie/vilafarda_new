                ...
                <form method="POST" action="{{ route('dashboard.homes.host-status', $home) }}">
                    ...
                    <div class="modal-body">
                        <p class="text-muted mb-3" style="font-size: 14px;">
                            لطفاً دلیل غیرفعال‌سازی را انتخاب کنید. تا زمان فعال‌سازی مجدد، اقامتگاه در صفحه اصلی و جستجو نمایش داده نمی‌شود و همه روزهای تقویم بسته می‌مانند. صفحه جزئیات برای گوگل باز می‌ماند.
                        </p>
