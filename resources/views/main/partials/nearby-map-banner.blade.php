...
<section class="index-section nearby-map-section" aria-labelledby="nearby-map-heading">
    <a href="{{ route('main.homes.index', ['map' => 1]) }}"
       ...
       aria-label="اقامتگاه‌های دوروبر — جستجو روی نقشه">
        <div class="nearby-map-banner__header index-section__header">
            <div class="nearby-map-banner__titles">
                <h2 id="nearby-map-heading" class="nearby-map-banner__title index-section__title">اقامتگاه‌های دوروبر</h2>
