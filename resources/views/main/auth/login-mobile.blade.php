    ...
    <div class="d-flex flex-column bd-highlight mb-3 align-items-center min-vh-100 px-3 pt-5">
        ...
        <div id="otp-step" class="w-100" style="display: none;">
            ...
            <div class="w-100 mt-4 d-flex justify-content-center gap-2" id="otp-boxes">
                <input type="tel" class="otp-input form-control text-center" maxlength="1" inputmode="numeric" pattern="[0-9]*" style="width: 50px; height: 50px; border-radius: 8px; font-size: 18px; font-weight: bold;">
                <input type="tel" class="otp-input form-control text-center" maxlength="1" inputmode="numeric" pattern="[0-9]*" style="width: 50px; height: 50px; border-radius: 8px; font-size: 18px; font-weight: bold;">
                <input type="tel" class="otp-input form-control text-center" maxlength="1" inputmode="numeric" pattern="[0-9]*" style="width: 50px; height: 50px; border-radius: 8px; font-size: 18px; font-weight: bold;">
                <input type="tel" class="otp-input form-control text-center" maxlength="1" inputmode="numeric" pattern="[0-9]*" style="width: 50px; height: 50px; border-radius: 8px; font-size: 18px; font-weight: bold;">
                <input type="tel" class="otp-input otp-input-autofill form-control text-center" maxlength="5" inputmode="numeric" pattern="[0-9]*" autocomplete="one-time-code" style="width: 50px; height: 50px; border-radius: 8px; font-size: 18px; font-weight: bold;">
            </div>
